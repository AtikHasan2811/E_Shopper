...
<head>
    ...
    <!--[if lt IE 9]>
    <script src="{{ asset('/') }}forntend/js/html5shiv.js"></script>
    <script src="{{ asset('/') }}forntend/js/respond.min.js"></script>
    <![endif]-->
            ...
            <div class="row">
                <div class="col-md-4 clearfix">
                    <div class="logo pull-left">
                        <a href="index.html"><img src="{{ asset('/') }}forntend/images/home/logo.png" alt="" /></a>
                    </div>
                ...
                <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            ...
                            <div class="col-sm-6">
                                <img src="{{ asset('/') }}forntend/images/home/girl1.jpg" class="girl img-responsive" alt="" />
                                <img src="{{ asset('/') }}forntend/images/home/pricing.png"  class="pricing" alt="" />
                            </div>
                        </div>
                        <div class="item">
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                <img src="{{ asset('/') }}forntend/images/home/girl2.jpg" class="girl img-responsive" alt="" />
                                <img src="{{ asset('/') }}forntend/images/home/pricing.png"  class="pricing" alt="" />
                            </div>
                        </div>
                        ...
                        <div class="item">
                            ...
                            <div class="col-sm-6">
                                <img src="{{ asset('/') }}forntend/images/home/girl3.jpg" class="girl img-responsive" alt="" />
                                <img src="{{ asset('/') }}forntend/images/home/pricing.png" class="pricing" alt="" />
                            </div>
                        </div>
                    ...
                    <div class="brands_products"><!--brands_products-->
                        ...
                        <div class="brands-name">
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li><a href="#"> <span class="pull-right">(50)</span>  {{  $row->BrandName }} </a></li>
                               <?php } ?>
